...
function build_toolchain {
    ...
    echo "BR2_WGET=\"wget --retry-on-host-error -nd -t 10 --no-check-certificate\"" >> ${output_dir}/.config
    echo "BR2_GNU_MIRROR=\"https://mirrors.kernel.org/gnu/\"" >> ${output_dir}/.config
